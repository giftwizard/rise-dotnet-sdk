# Org.OpenAPITools.Model.WalletAction6
...
------------ | ------------- | ------------- | -------------
**Amount** | **string** | The amount to be added to the Wallet. | 
**StoreCreditContext** | [**StoreCreditContext1**](StoreCreditContext1.md) |  | 
**WalletId** | **string** | ID of the wallet to which the WalletAction belongs. | 

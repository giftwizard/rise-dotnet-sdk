...
<a id="countwallets"></a>
# **CountWallets**
> CountWalletsResponse1 CountWallets (WalletWalletServiceV1RiseWalletsCountPostCountWalletsRequestBody walletWalletServiceV1RiseWalletsCountPostCountWalletsRequestBody)
...
[**CountWalletsResponse1**](CountWalletsResponse1.md)
...
> GetCustomerReferenceResponse1 GetCustomerReference (CustomerReferenceQuery query)
...
[**GetCustomerReferenceResponse1**](GetCustomerReferenceResponse1.md)
...
# **GetOrCreateWallet**
> GetOrCreateWalletResponse1 GetOrCreateWallet (WalletWalletServiceV1RiseWalletsIssuePostGetOrCreateWalletRequestBody walletWalletServiceV1RiseWalletsIssuePostGetOrCreateWalletRequestBody)
...
[**GetOrCreateWalletResponse1**](GetOrCreateWalletResponse1.md)
...
<a id="getwallet"></a>
# **GetWallet**
> GetWalletResponse1 GetWallet (Object query)
...
[**GetWalletResponse1**](GetWalletResponse1.md)
...
<a id="querywallets"></a>
# **QueryWallets**
> QueryWalletsResponse1 QueryWallets (WalletWalletServiceV1RiseWalletsQueryPostQueryWalletsRequestBody walletWalletServiceV1RiseWalletsQueryPostQueryWalletsRequestBody)
...
| Name | Type | Description | Notes |
|------|------|-------------|-------|
| **walletWalletServiceV1RiseWalletsQueryPostQueryWalletsRequestBody** | [**WalletWalletServiceV1RiseWalletsQueryPostQueryWalletsRequestBody**](WalletWalletServiceV1RiseWalletsQueryPostQueryWalletsRequestBody.md) |  |  |

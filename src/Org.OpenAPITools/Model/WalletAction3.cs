...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    public partial class WalletAction3 : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="WalletAction3" /> class.
        /// </summary>
        ...
        [JsonConstructor]
        public WalletAction3(Option<string?> id = default, Option<string?> revision = default, Option<DateTime?> createdDate = default, Option<DateTime?> updatedDate = default, Option<DateTime?> startDate = default, Option<DateTime?> expirationDate = default, Option<DateTime?> disableDate = default, Option<string?> amount = default, Option<string?> note = default, Option<TypeEnum?> type = default, Option<WalletActionExecutionDetails1?> walletActionStarted = default, Option<WalletActionExecutionDetails2?> walletActionEnded = default, Option<StatusEnum?> status = default, Option<ActionInitiator2?> source = default, Option<Notifications1?> notifications = default, Option<bool?> liability = default, Option<StoreCreditContext2?> storeCreditContext = default, Option<ExternalEvent2?> externalEvent = default, Option<string?> walletId = default, Option<string?> idempotencyKey = default)
        {
            IdOption = id;
    ...
    /// <summary>
    /// A Json converter for type <see cref="WalletAction3" />
    /// </summary>
    public class WalletAction3JsonConverter : JsonConverter<WalletAction3>
    {
        /// <summary>
        ...
        /// <summary>
        /// Deserializes json to <see cref="WalletAction3" />
        /// </summary>
        ...
        public override WalletAction3 Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<WalletAction3.TypeEnum?> type = default;
            ...
            Option<WalletAction3.StatusEnum?> status = default;
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        ...
                        case "type":
                            ...
                            if (typeRawValue != null)
                                type = new Option<WalletAction3.TypeEnum?>(WalletAction3.TypeEnumFromStringOrDefault(typeRawValue));
                            break;
                        ...
                        case "status":
                            ...
                            if (statusRawValue != null)
                                status = new Option<WalletAction3.StatusEnum?>(WalletAction3.StatusEnumFromStringOrDefault(statusRawValue));
                            break;
                        case "source":
            ...
            if (id.IsSet && id.Value == null)
                throw new ArgumentNullException(nameof(id), "Property is not nullable for class WalletAction3.");

            if (revision.IsSet && revision.Value == null)
                throw new ArgumentNullException(nameof(revision), "Property is not nullable for class WalletAction3.");

            if (createdDate.IsSet && createdDate.Value == null)
                throw new ArgumentNullException(nameof(createdDate), "Property is not nullable for class WalletAction3.");

            if (updatedDate.IsSet && updatedDate.Value == null)
                throw new ArgumentNullException(nameof(updatedDate), "Property is not nullable for class WalletAction3.");

            if (startDate.IsSet && startDate.Value == null)
                throw new ArgumentNullException(nameof(startDate), "Property is not nullable for class WalletAction3.");

            if (expirationDate.IsSet && expirationDate.Value == null)
                throw new ArgumentNullException(nameof(expirationDate), "Property is not nullable for class WalletAction3.");

            if (disableDate.IsSet && disableDate.Value == null)
                throw new ArgumentNullException(nameof(disableDate), "Property is not nullable for class WalletAction3.");

            if (amount.IsSet && amount.Value == null)
                throw new ArgumentNullException(nameof(amount), "Property is not nullable for class WalletAction3.");

            if (note.IsSet && note.Value == null)
                throw new ArgumentNullException(nameof(note), "Property is not nullable for class WalletAction3.");

            if (type.IsSet && type.Value == null)
                throw new ArgumentNullException(nameof(type), "Property is not nullable for class WalletAction3.");

            if (walletActionStarted.IsSet && walletActionStarted.Value == null)
                throw new ArgumentNullException(nameof(walletActionStarted), "Property is not nullable for class WalletAction3.");

            if (walletActionEnded.IsSet && walletActionEnded.Value == null)
                throw new ArgumentNullException(nameof(walletActionEnded), "Property is not nullable for class WalletAction3.");

            if (status.IsSet && status.Value == null)
                throw new ArgumentNullException(nameof(status), "Property is not nullable for class WalletAction3.");

            if (source.IsSet && source.Value == null)
                throw new ArgumentNullException(nameof(source), "Property is not nullable for class WalletAction3.");

            if (notifications.IsSet && notifications.Value == null)
                throw new ArgumentNullException(nameof(notifications), "Property is not nullable for class WalletAction3.");

            if (liability.IsSet && liability.Value == null)
                throw new ArgumentNullException(nameof(liability), "Property is not nullable for class WalletAction3.");

            if (storeCreditContext.IsSet && storeCreditContext.Value == null)
                throw new ArgumentNullException(nameof(storeCreditContext), "Property is not nullable for class WalletAction3.");

            if (externalEvent.IsSet && externalEvent.Value == null)
                throw new ArgumentNullException(nameof(externalEvent), "Property is not nullable for class WalletAction3.");

            if (walletId.IsSet && walletId.Value == null)
                throw new ArgumentNullException(nameof(walletId), "Property is not nullable for class WalletAction3.");

            if (idempotencyKey.IsSet && idempotencyKey.Value == null)
                throw new ArgumentNullException(nameof(idempotencyKey), "Property is not nullable for class WalletAction3.");

            return new WalletAction3(id, revision, createdDate, updatedDate, startDate, expirationDate, disableDate, amount, note, type, walletActionStarted, walletActionEnded, status, source, notifications, liability, storeCreditContext, externalEvent, walletId, idempotencyKey);
        }

        /// <summary>
        /// Serializes a <see cref="WalletAction3" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="walletAction3"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, WalletAction3 walletAction3, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, walletAction3, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="WalletAction3" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="walletAction3"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, WalletAction3 walletAction3, JsonSerializerOptions jsonSerializerOptions)
        {
            if (walletAction3.IdOption.IsSet && walletAction3.Id == null)
                throw new ArgumentNullException(nameof(walletAction3.Id), "Property is required for class WalletAction3.");

            if (walletAction3.RevisionOption.IsSet && walletAction3.Revision == null)
                throw new ArgumentNullException(nameof(walletAction3.Revision), "Property is required for class WalletAction3.");

            if (walletAction3.AmountOption.IsSet && walletAction3.Amount == null)
                throw new ArgumentNullException(nameof(walletAction3.Amount), "Property is required for class WalletAction3.");

            if (walletAction3.NoteOption.IsSet && walletAction3.Note == null)
                throw new ArgumentNullException(nameof(walletAction3.Note), "Property is required for class WalletAction3.");

            if (walletAction3.WalletActionStartedOption.IsSet && walletAction3.WalletActionStarted == null)
                throw new ArgumentNullException(nameof(walletAction3.WalletActionStarted), "Property is required for class WalletAction3.");

            if (walletAction3.WalletActionEndedOption.IsSet && walletAction3.WalletActionEnded == null)
                throw new ArgumentNullException(nameof(walletAction3.WalletActionEnded), "Property is required for class WalletAction3.");

            if (walletAction3.SourceOption.IsSet && walletAction3.Source == null)
                throw new ArgumentNullException(nameof(walletAction3.Source), "Property is required for class WalletAction3.");

            if (walletAction3.NotificationsOption.IsSet && walletAction3.Notifications == null)
                throw new ArgumentNullException(nameof(walletAction3.Notifications), "Property is required for class WalletAction3.");

            if (walletAction3.StoreCreditContextOption.IsSet && walletAction3.StoreCreditContext == null)
                throw new ArgumentNullException(nameof(walletAction3.StoreCreditContext), "Property is required for class WalletAction3.");

            if (walletAction3.ExternalEventOption.IsSet && walletAction3.ExternalEvent == null)
                throw new ArgumentNullException(nameof(walletAction3.ExternalEvent), "Property is required for class WalletAction3.");

            if (walletAction3.WalletIdOption.IsSet && walletAction3.WalletId == null)
                throw new ArgumentNullException(nameof(walletAction3.WalletId), "Property is required for class WalletAction3.");

            if (walletAction3.IdempotencyKeyOption.IsSet && walletAction3.IdempotencyKey == null)
                throw new ArgumentNullException(nameof(walletAction3.IdempotencyKey), "Property is required for class WalletAction3.");

            if (walletAction3.IdOption.IsSet)
                writer.WriteString("id", walletAction3.Id);

            if (walletAction3.RevisionOption.IsSet)
                writer.WriteString("revision", walletAction3.Revision);

            if (walletAction3.CreatedDateOption.IsSet)
                writer.WriteString("createdDate", walletAction3.CreatedDateOption.Value!.Value.ToString(CreatedDateFormat));

            if (walletAction3.UpdatedDateOption.IsSet)
                writer.WriteString("updatedDate", walletAction3.UpdatedDateOption.Value!.Value.ToString(UpdatedDateFormat));

            if (walletAction3.StartDateOption.IsSet)
                writer.WriteString("startDate", walletAction3.StartDateOption.Value!.Value.ToString(StartDateFormat));

            if (walletAction3.ExpirationDateOption.IsSet)
                writer.WriteString("expirationDate", walletAction3.ExpirationDateOption.Value!.Value.ToString(ExpirationDateFormat));

            if (walletAction3.DisableDateOption.IsSet)
                writer.WriteString("disableDate", walletAction3.DisableDateOption.Value!.Value.ToString(DisableDateFormat));

            if (walletAction3.AmountOption.IsSet)
                writer.WriteString("amount", walletAction3.Amount);

            if (walletAction3.NoteOption.IsSet)
                writer.WriteString("note", walletAction3.Note);

            var typeRawValue = WalletAction3.TypeEnumToJsonValue(walletAction3.TypeOption.Value!.Value);
            writer.WriteString("type", typeRawValue);
            if (walletAction3.WalletActionStartedOption.IsSet)
            {
                writer.WritePropertyName("walletActionStarted");
                JsonSerializer.Serialize(writer, walletAction3.WalletActionStarted, jsonSerializerOptions);
            }
            if (walletAction3.WalletActionEndedOption.IsSet)
            {
                writer.WritePropertyName("walletActionEnded");
                JsonSerializer.Serialize(writer, walletAction3.WalletActionEnded, jsonSerializerOptions);
            }
            var statusRawValue = WalletAction3.StatusEnumToJsonValue(walletAction3.StatusOption.Value!.Value);
            writer.WriteString("status", statusRawValue);
            if (walletAction3.SourceOption.IsSet)
            {
                writer.WritePropertyName("source");
                JsonSerializer.Serialize(writer, walletAction3.Source, jsonSerializerOptions);
            }
            if (walletAction3.NotificationsOption.IsSet)
            {
                writer.WritePropertyName("notifications");
                JsonSerializer.Serialize(writer, walletAction3.Notifications, jsonSerializerOptions);
            }
            if (walletAction3.LiabilityOption.IsSet)
                writer.WriteBoolean("liability", walletAction3.LiabilityOption.Value!.Value);

            if (walletAction3.StoreCreditContextOption.IsSet)
            {
                writer.WritePropertyName("storeCreditContext");
                JsonSerializer.Serialize(writer, walletAction3.StoreCreditContext, jsonSerializerOptions);
            }
            if (walletAction3.ExternalEventOption.IsSet)
            {
                writer.WritePropertyName("externalEvent");
                JsonSerializer.Serialize(writer, walletAction3.ExternalEvent, jsonSerializerOptions);
            }
            if (walletAction3.WalletIdOption.IsSet)
                writer.WriteString("walletId", walletAction3.WalletId);

            if (walletAction3.IdempotencyKeyOption.IsSet)
                writer.WriteString("idempotencyKey", walletAction3.IdempotencyKey);
        }
    }
}

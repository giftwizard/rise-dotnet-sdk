...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    public partial class WalletAction7 : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="WalletAction7" /> class.
        /// </summary>
        ...
        [JsonConstructor]
        public WalletAction7(string amount, StoreCreditContext2 storeCreditContext, Option<string?> id = default, Option<string?> revision = default, Option<DateTime?> createdDate = default, Option<DateTime?> updatedDate = default, Option<DateTime?> startDate = default, Option<DateTime?> expirationDate = default, Option<DateTime?> disableDate = default, Option<string?> note = default, Option<TypeEnum?> type = default, Option<WalletActionExecutionDetails1?> walletActionStarted = default, Option<WalletActionExecutionDetails2?> walletActionEnded = default, Option<StatusEnum?> status = default, Option<ActionInitiator2?> source = default, Option<Notifications1?> notifications = default, Option<bool?> liability = default, Option<ExternalEvent2?> externalEvent = default, Option<string?> walletId = default, Option<string?> idempotencyKey = default)
        {
            Amount = amount;
        ...
        public StoreCreditContext2 StoreCreditContext { get; set; }
    ...
    /// <summary>
    /// A Json converter for type <see cref="WalletAction7" />
    /// </summary>
    public class WalletAction7JsonConverter : JsonConverter<WalletAction7>
    {
        /// <summary>
        ...
        /// <summary>
        /// Deserializes json to <see cref="WalletAction7" />
        /// </summary>
        ...
        public override WalletAction7 Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<WalletAction7.TypeEnum?> type = default;
            ...
            Option<WalletAction7.StatusEnum?> status = default;
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        ...
                        case "type":
                            ...
                            if (typeRawValue != null)
                                type = new Option<WalletAction7.TypeEnum?>(WalletAction7.TypeEnumFromStringOrDefault(typeRawValue));
                            break;
                        ...
                        case "status":
                            ...
                            if (statusRawValue != null)
                                status = new Option<WalletAction7.StatusEnum?>(WalletAction7.StatusEnumFromStringOrDefault(statusRawValue));
                            break;
                        case "source":
            ...
            if (!amount.IsSet)
                throw new ArgumentException("Property is required for class WalletAction7.", nameof(amount));

            if (!storeCreditContext.IsSet)
                throw new ArgumentException("Property is required for class WalletAction7.", nameof(storeCreditContext));

            if (amount.IsSet && amount.Value == null)
                throw new ArgumentNullException(nameof(amount), "Property is not nullable for class WalletAction7.");

            if (storeCreditContext.IsSet && storeCreditContext.Value == null)
                throw new ArgumentNullException(nameof(storeCreditContext), "Property is not nullable for class WalletAction7.");

            if (id.IsSet && id.Value == null)
                throw new ArgumentNullException(nameof(id), "Property is not nullable for class WalletAction7.");

            if (revision.IsSet && revision.Value == null)
                throw new ArgumentNullException(nameof(revision), "Property is not nullable for class WalletAction7.");

            if (createdDate.IsSet && createdDate.Value == null)
                throw new ArgumentNullException(nameof(createdDate), "Property is not nullable for class WalletAction7.");

            if (updatedDate.IsSet && updatedDate.Value == null)
                throw new ArgumentNullException(nameof(updatedDate), "Property is not nullable for class WalletAction7.");

            if (startDate.IsSet && startDate.Value == null)
                throw new ArgumentNullException(nameof(startDate), "Property is not nullable for class WalletAction7.");

            if (expirationDate.IsSet && expirationDate.Value == null)
                throw new ArgumentNullException(nameof(expirationDate), "Property is not nullable for class WalletAction7.");

            if (disableDate.IsSet && disableDate.Value == null)
                throw new ArgumentNullException(nameof(disableDate), "Property is not nullable for class WalletAction7.");

            if (note.IsSet && note.Value == null)
                throw new ArgumentNullException(nameof(note), "Property is not nullable for class WalletAction7.");

            if (type.IsSet && type.Value == null)
                throw new ArgumentNullException(nameof(type), "Property is not nullable for class WalletAction7.");

            if (walletActionStarted.IsSet && walletActionStarted.Value == null)
                throw new ArgumentNullException(nameof(walletActionStarted), "Property is not nullable for class WalletAction7.");

            if (walletActionEnded.IsSet && walletActionEnded.Value == null)
                throw new ArgumentNullException(nameof(walletActionEnded), "Property is not nullable for class WalletAction7.");

            if (status.IsSet && status.Value == null)
                throw new ArgumentNullException(nameof(status), "Property is not nullable for class WalletAction7.");

            if (source.IsSet && source.Value == null)
                throw new ArgumentNullException(nameof(source), "Property is not nullable for class WalletAction7.");

            if (notifications.IsSet && notifications.Value == null)
                throw new ArgumentNullException(nameof(notifications), "Property is not nullable for class WalletAction7.");

            if (liability.IsSet && liability.Value == null)
                throw new ArgumentNullException(nameof(liability), "Property is not nullable for class WalletAction7.");

            if (externalEvent.IsSet && externalEvent.Value == null)
                throw new ArgumentNullException(nameof(externalEvent), "Property is not nullable for class WalletAction7.");

            if (walletId.IsSet && walletId.Value == null)
                throw new ArgumentNullException(nameof(walletId), "Property is not nullable for class WalletAction7.");

            if (idempotencyKey.IsSet && idempotencyKey.Value == null)
                throw new ArgumentNullException(nameof(idempotencyKey), "Property is not nullable for class WalletAction7.");

            return new WalletAction7(amount.Value!, storeCreditContext.Value!, id, revision, createdDate, updatedDate, startDate, expirationDate, disableDate, note, type, walletActionStarted, walletActionEnded, status, source, notifications, liability, externalEvent, walletId, idempotencyKey);
        }

        /// <summary>
        /// Serializes a <see cref="WalletAction7" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="walletAction7"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, WalletAction7 walletAction7, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, walletAction7, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="WalletAction7" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="walletAction7"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, WalletAction7 walletAction7, JsonSerializerOptions jsonSerializerOptions)
        {
            if (walletAction7.Amount == null)
                throw new ArgumentNullException(nameof(walletAction7.Amount), "Property is required for class WalletAction7.");

            if (walletAction7.StoreCreditContext == null)
                throw new ArgumentNullException(nameof(walletAction7.StoreCreditContext), "Property is required for class WalletAction7.");

            if (walletAction7.IdOption.IsSet && walletAction7.Id == null)
                throw new ArgumentNullException(nameof(walletAction7.Id), "Property is required for class WalletAction7.");

            if (walletAction7.RevisionOption.IsSet && walletAction7.Revision == null)
                throw new ArgumentNullException(nameof(walletAction7.Revision), "Property is required for class WalletAction7.");

            if (walletAction7.NoteOption.IsSet && walletAction7.Note == null)
                throw new ArgumentNullException(nameof(walletAction7.Note), "Property is required for class WalletAction7.");

            if (walletAction7.WalletActionStartedOption.IsSet && walletAction7.WalletActionStarted == null)
                throw new ArgumentNullException(nameof(walletAction7.WalletActionStarted), "Property is required for class WalletAction7.");

            if (walletAction7.WalletActionEndedOption.IsSet && walletAction7.WalletActionEnded == null)
                throw new ArgumentNullException(nameof(walletAction7.WalletActionEnded), "Property is required for class WalletAction7.");

            if (walletAction7.SourceOption.IsSet && walletAction7.Source == null)
                throw new ArgumentNullException(nameof(walletAction7.Source), "Property is required for class WalletAction7.");

            if (walletAction7.NotificationsOption.IsSet && walletAction7.Notifications == null)
                throw new ArgumentNullException(nameof(walletAction7.Notifications), "Property is required for class WalletAction7.");

            if (walletAction7.ExternalEventOption.IsSet && walletAction7.ExternalEvent == null)
                throw new ArgumentNullException(nameof(walletAction7.ExternalEvent), "Property is required for class WalletAction7.");

            if (walletAction7.WalletIdOption.IsSet && walletAction7.WalletId == null)
                throw new ArgumentNullException(nameof(walletAction7.WalletId), "Property is required for class WalletAction7.");

            if (walletAction7.IdempotencyKeyOption.IsSet && walletAction7.IdempotencyKey == null)
                throw new ArgumentNullException(nameof(walletAction7.IdempotencyKey), "Property is required for class WalletAction7.");

            writer.WriteString("amount", walletAction7.Amount);

            writer.WritePropertyName("storeCreditContext");
            JsonSerializer.Serialize(writer, walletAction7.StoreCreditContext, jsonSerializerOptions);
            if (walletAction7.IdOption.IsSet)
                writer.WriteString("id", walletAction7.Id);

            if (walletAction7.RevisionOption.IsSet)
                writer.WriteString("revision", walletAction7.Revision);

            if (walletAction7.CreatedDateOption.IsSet)
                writer.WriteString("createdDate", walletAction7.CreatedDateOption.Value!.Value.ToString(CreatedDateFormat));

            if (walletAction7.UpdatedDateOption.IsSet)
                writer.WriteString("updatedDate", walletAction7.UpdatedDateOption.Value!.Value.ToString(UpdatedDateFormat));

            if (walletAction7.StartDateOption.IsSet)
                writer.WriteString("startDate", walletAction7.StartDateOption.Value!.Value.ToString(StartDateFormat));

            if (walletAction7.ExpirationDateOption.IsSet)
                writer.WriteString("expirationDate", walletAction7.ExpirationDateOption.Value!.Value.ToString(ExpirationDateFormat));

            if (walletAction7.DisableDateOption.IsSet)
                writer.WriteString("disableDate", walletAction7.DisableDateOption.Value!.Value.ToString(DisableDateFormat));

            if (walletAction7.NoteOption.IsSet)
                writer.WriteString("note", walletAction7.Note);

            var typeRawValue = WalletAction7.TypeEnumToJsonValue(walletAction7.TypeOption.Value!.Value);
            writer.WriteString("type", typeRawValue);
            if (walletAction7.WalletActionStartedOption.IsSet)
            {
                writer.WritePropertyName("walletActionStarted");
                JsonSerializer.Serialize(writer, walletAction7.WalletActionStarted, jsonSerializerOptions);
            }
            if (walletAction7.WalletActionEndedOption.IsSet)
            {
                writer.WritePropertyName("walletActionEnded");
                JsonSerializer.Serialize(writer, walletAction7.WalletActionEnded, jsonSerializerOptions);
            }
            var statusRawValue = WalletAction7.StatusEnumToJsonValue(walletAction7.StatusOption.Value!.Value);
            writer.WriteString("status", statusRawValue);
            if (walletAction7.SourceOption.IsSet)
            {
                writer.WritePropertyName("source");
                JsonSerializer.Serialize(writer, walletAction7.Source, jsonSerializerOptions);
            }
            if (walletAction7.NotificationsOption.IsSet)
            {
                writer.WritePropertyName("notifications");
                JsonSerializer.Serialize(writer, walletAction7.Notifications, jsonSerializerOptions);
            }
            if (walletAction7.LiabilityOption.IsSet)
                writer.WriteBoolean("liability", walletAction7.LiabilityOption.Value!.Value);

            if (walletAction7.ExternalEventOption.IsSet)
            {
                writer.WritePropertyName("externalEvent");
                JsonSerializer.Serialize(writer, walletAction7.ExternalEvent, jsonSerializerOptions);
            }
            if (walletAction7.WalletIdOption.IsSet)
                writer.WriteString("walletId", walletAction7.WalletId);

            if (walletAction7.IdempotencyKeyOption.IsSet)
                writer.WriteString("idempotencyKey", walletAction7.IdempotencyKey);
        }
    }
}

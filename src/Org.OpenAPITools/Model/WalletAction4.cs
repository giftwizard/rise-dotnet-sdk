...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    public partial class WalletAction4 : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="WalletAction4" /> class.
        /// </summary>
        ...
        [JsonConstructor]
        public WalletAction4(Option<string?> id = default, Option<string?> revision = default, Option<DateTime?> createdDate = default, Option<DateTime?> updatedDate = default, Option<DateTime?> startDate = default, Option<DateTime?> expirationDate = default, Option<DateTime?> disableDate = default, Option<string?> amount = default, Option<string?> note = default, Option<TypeEnum?> type = default, Option<WalletActionExecutionDetails1?> walletActionStarted = default, Option<WalletActionExecutionDetails2?> walletActionEnded = default, Option<StatusEnum?> status = default, Option<ActionInitiator2?> source = default, Option<Notifications1?> notifications = default, Option<bool?> liability = default, Option<StoreCreditContext2?> storeCreditContext = default, Option<ExternalEvent2?> externalEvent = default, Option<string?> walletId = default, Option<string?> idempotencyKey = default)
        {
            IdOption = id;
    ...
    /// <summary>
    /// A Json converter for type <see cref="WalletAction4" />
    /// </summary>
    public class WalletAction4JsonConverter : JsonConverter<WalletAction4>
    {
        /// <summary>
        ...
        /// <summary>
        /// Deserializes json to <see cref="WalletAction4" />
        /// </summary>
        ...
        public override WalletAction4 Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<WalletAction4.TypeEnum?> type = default;
            ...
            Option<WalletAction4.StatusEnum?> status = default;
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        ...
                        case "type":
                            ...
                            if (typeRawValue != null)
                                type = new Option<WalletAction4.TypeEnum?>(WalletAction4.TypeEnumFromStringOrDefault(typeRawValue));
                            break;
                        ...
                        case "status":
                            ...
                            if (statusRawValue != null)
                                status = new Option<WalletAction4.StatusEnum?>(WalletAction4.StatusEnumFromStringOrDefault(statusRawValue));
                            break;
                        case "source":
            ...
            if (id.IsSet && id.Value == null)
                throw new ArgumentNullException(nameof(id), "Property is not nullable for class WalletAction4.");

            if (revision.IsSet && revision.Value == null)
                throw new ArgumentNullException(nameof(revision), "Property is not nullable for class WalletAction4.");

            if (createdDate.IsSet && createdDate.Value == null)
                throw new ArgumentNullException(nameof(createdDate), "Property is not nullable for class WalletAction4.");

            if (updatedDate.IsSet && updatedDate.Value == null)
                throw new ArgumentNullException(nameof(updatedDate), "Property is not nullable for class WalletAction4.");

            if (startDate.IsSet && startDate.Value == null)
                throw new ArgumentNullException(nameof(startDate), "Property is not nullable for class WalletAction4.");

            if (expirationDate.IsSet && expirationDate.Value == null)
                throw new ArgumentNullException(nameof(expirationDate), "Property is not nullable for class WalletAction4.");

            if (disableDate.IsSet && disableDate.Value == null)
                throw new ArgumentNullException(nameof(disableDate), "Property is not nullable for class WalletAction4.");

            if (amount.IsSet && amount.Value == null)
                throw new ArgumentNullException(nameof(amount), "Property is not nullable for class WalletAction4.");

            if (note.IsSet && note.Value == null)
                throw new ArgumentNullException(nameof(note), "Property is not nullable for class WalletAction4.");

            if (type.IsSet && type.Value == null)
                throw new ArgumentNullException(nameof(type), "Property is not nullable for class WalletAction4.");

            if (walletActionStarted.IsSet && walletActionStarted.Value == null)
                throw new ArgumentNullException(nameof(walletActionStarted), "Property is not nullable for class WalletAction4.");

            if (walletActionEnded.IsSet && walletActionEnded.Value == null)
                throw new ArgumentNullException(nameof(walletActionEnded), "Property is not nullable for class WalletAction4.");

            if (status.IsSet && status.Value == null)
                throw new ArgumentNullException(nameof(status), "Property is not nullable for class WalletAction4.");

            if (source.IsSet && source.Value == null)
                throw new ArgumentNullException(nameof(source), "Property is not nullable for class WalletAction4.");

            if (notifications.IsSet && notifications.Value == null)
                throw new ArgumentNullException(nameof(notifications), "Property is not nullable for class WalletAction4.");

            if (liability.IsSet && liability.Value == null)
                throw new ArgumentNullException(nameof(liability), "Property is not nullable for class WalletAction4.");

            if (storeCreditContext.IsSet && storeCreditContext.Value == null)
                throw new ArgumentNullException(nameof(storeCreditContext), "Property is not nullable for class WalletAction4.");

            if (externalEvent.IsSet && externalEvent.Value == null)
                throw new ArgumentNullException(nameof(externalEvent), "Property is not nullable for class WalletAction4.");

            if (walletId.IsSet && walletId.Value == null)
                throw new ArgumentNullException(nameof(walletId), "Property is not nullable for class WalletAction4.");

            if (idempotencyKey.IsSet && idempotencyKey.Value == null)
                throw new ArgumentNullException(nameof(idempotencyKey), "Property is not nullable for class WalletAction4.");

            return new WalletAction4(id, revision, createdDate, updatedDate, startDate, expirationDate, disableDate, amount, note, type, walletActionStarted, walletActionEnded, status, source, notifications, liability, storeCreditContext, externalEvent, walletId, idempotencyKey);
        }

        /// <summary>
        /// Serializes a <see cref="WalletAction4" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="walletAction4"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, WalletAction4 walletAction4, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, walletAction4, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="WalletAction4" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="walletAction4"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, WalletAction4 walletAction4, JsonSerializerOptions jsonSerializerOptions)
        {
            if (walletAction4.IdOption.IsSet && walletAction4.Id == null)
                throw new ArgumentNullException(nameof(walletAction4.Id), "Property is required for class WalletAction4.");

            if (walletAction4.RevisionOption.IsSet && walletAction4.Revision == null)
                throw new ArgumentNullException(nameof(walletAction4.Revision), "Property is required for class WalletAction4.");

            if (walletAction4.AmountOption.IsSet && walletAction4.Amount == null)
                throw new ArgumentNullException(nameof(walletAction4.Amount), "Property is required for class WalletAction4.");

            if (walletAction4.NoteOption.IsSet && walletAction4.Note == null)
                throw new ArgumentNullException(nameof(walletAction4.Note), "Property is required for class WalletAction4.");

            if (walletAction4.WalletActionStartedOption.IsSet && walletAction4.WalletActionStarted == null)
                throw new ArgumentNullException(nameof(walletAction4.WalletActionStarted), "Property is required for class WalletAction4.");

            if (walletAction4.WalletActionEndedOption.IsSet && walletAction4.WalletActionEnded == null)
                throw new ArgumentNullException(nameof(walletAction4.WalletActionEnded), "Property is required for class WalletAction4.");

            if (walletAction4.SourceOption.IsSet && walletAction4.Source == null)
                throw new ArgumentNullException(nameof(walletAction4.Source), "Property is required for class WalletAction4.");

            if (walletAction4.NotificationsOption.IsSet && walletAction4.Notifications == null)
                throw new ArgumentNullException(nameof(walletAction4.Notifications), "Property is required for class WalletAction4.");

            if (walletAction4.StoreCreditContextOption.IsSet && walletAction4.StoreCreditContext == null)
                throw new ArgumentNullException(nameof(walletAction4.StoreCreditContext), "Property is required for class WalletAction4.");

            if (walletAction4.ExternalEventOption.IsSet && walletAction4.ExternalEvent == null)
                throw new ArgumentNullException(nameof(walletAction4.ExternalEvent), "Property is required for class WalletAction4.");

            if (walletAction4.WalletIdOption.IsSet && walletAction4.WalletId == null)
                throw new ArgumentNullException(nameof(walletAction4.WalletId), "Property is required for class WalletAction4.");

            if (walletAction4.IdempotencyKeyOption.IsSet && walletAction4.IdempotencyKey == null)
                throw new ArgumentNullException(nameof(walletAction4.IdempotencyKey), "Property is required for class WalletAction4.");

            if (walletAction4.IdOption.IsSet)
                writer.WriteString("id", walletAction4.Id);

            if (walletAction4.RevisionOption.IsSet)
                writer.WriteString("revision", walletAction4.Revision);

            if (walletAction4.CreatedDateOption.IsSet)
                writer.WriteString("createdDate", walletAction4.CreatedDateOption.Value!.Value.ToString(CreatedDateFormat));

            if (walletAction4.UpdatedDateOption.IsSet)
                writer.WriteString("updatedDate", walletAction4.UpdatedDateOption.Value!.Value.ToString(UpdatedDateFormat));

            if (walletAction4.StartDateOption.IsSet)
                writer.WriteString("startDate", walletAction4.StartDateOption.Value!.Value.ToString(StartDateFormat));

            if (walletAction4.ExpirationDateOption.IsSet)
                writer.WriteString("expirationDate", walletAction4.ExpirationDateOption.Value!.Value.ToString(ExpirationDateFormat));

            if (walletAction4.DisableDateOption.IsSet)
                writer.WriteString("disableDate", walletAction4.DisableDateOption.Value!.Value.ToString(DisableDateFormat));

            if (walletAction4.AmountOption.IsSet)
                writer.WriteString("amount", walletAction4.Amount);

            if (walletAction4.NoteOption.IsSet)
                writer.WriteString("note", walletAction4.Note);

            var typeRawValue = WalletAction4.TypeEnumToJsonValue(walletAction4.TypeOption.Value!.Value);
            writer.WriteString("type", typeRawValue);
            if (walletAction4.WalletActionStartedOption.IsSet)
            {
                writer.WritePropertyName("walletActionStarted");
                JsonSerializer.Serialize(writer, walletAction4.WalletActionStarted, jsonSerializerOptions);
            }
            if (walletAction4.WalletActionEndedOption.IsSet)
            {
                writer.WritePropertyName("walletActionEnded");
                JsonSerializer.Serialize(writer, walletAction4.WalletActionEnded, jsonSerializerOptions);
            }
            var statusRawValue = WalletAction4.StatusEnumToJsonValue(walletAction4.StatusOption.Value!.Value);
            writer.WriteString("status", statusRawValue);
            if (walletAction4.SourceOption.IsSet)
            {
                writer.WritePropertyName("source");
                JsonSerializer.Serialize(writer, walletAction4.Source, jsonSerializerOptions);
            }
            if (walletAction4.NotificationsOption.IsSet)
            {
                writer.WritePropertyName("notifications");
                JsonSerializer.Serialize(writer, walletAction4.Notifications, jsonSerializerOptions);
            }
            if (walletAction4.LiabilityOption.IsSet)
                writer.WriteBoolean("liability", walletAction4.LiabilityOption.Value!.Value);

            if (walletAction4.StoreCreditContextOption.IsSet)
            {
                writer.WritePropertyName("storeCreditContext");
                JsonSerializer.Serialize(writer, walletAction4.StoreCreditContext, jsonSerializerOptions);
            }
            if (walletAction4.ExternalEventOption.IsSet)
            {
                writer.WritePropertyName("externalEvent");
                JsonSerializer.Serialize(writer, walletAction4.ExternalEvent, jsonSerializerOptions);
            }
            if (walletAction4.WalletIdOption.IsSet)
                writer.WriteString("walletId", walletAction4.WalletId);

            if (walletAction4.IdempotencyKeyOption.IsSet)
                writer.WriteString("idempotencyKey", walletAction4.IdempotencyKey);
        }
    }
}

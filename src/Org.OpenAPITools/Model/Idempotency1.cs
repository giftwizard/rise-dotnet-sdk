...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    public partial class Idempotency1 : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Idempotency1" /> class.
        /// </summary>
        ...
        [JsonConstructor]
        public Idempotency1(Option<string?> key = default, Option<string?> ttlInMilliseconds = default)
        {
            KeyOption = key;
    ...
    /// <summary>
    /// A Json converter for type <see cref="Idempotency1" />
    /// </summary>
    public class Idempotency1JsonConverter : JsonConverter<Idempotency1>
    {
        /// <summary>
        /// Deserializes json to <see cref="Idempotency1" />
        /// </summary>
        ...
        public override Idempotency1 Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (key.IsSet && key.Value == null)
                throw new ArgumentNullException(nameof(key), "Property is not nullable for class Idempotency1.");

            if (ttlInMilliseconds.IsSet && ttlInMilliseconds.Value == null)
                throw new ArgumentNullException(nameof(ttlInMilliseconds), "Property is not nullable for class Idempotency1.");

            return new Idempotency1(key, ttlInMilliseconds);
        }

        /// <summary>
        /// Serializes a <see cref="Idempotency1" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="idempotency1"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, Idempotency1 idempotency1, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, idempotency1, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="Idempotency1" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="idempotency1"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, Idempotency1 idempotency1, JsonSerializerOptions jsonSerializerOptions)
        {
            if (idempotency1.KeyOption.IsSet && idempotency1.Key == null)
                throw new ArgumentNullException(nameof(idempotency1.Key), "Property is required for class Idempotency1.");

            if (idempotency1.TtlInMillisecondsOption.IsSet && idempotency1.TtlInMilliseconds == null)
                throw new ArgumentNullException(nameof(idempotency1.TtlInMilliseconds), "Property is required for class Idempotency1.");

            if (idempotency1.KeyOption.IsSet)
                writer.WriteString("key", idempotency1.Key);

            if (idempotency1.TtlInMillisecondsOption.IsSet)
                writer.WriteString("ttlInMilliseconds", idempotency1.TtlInMilliseconds);
        }
    }
}

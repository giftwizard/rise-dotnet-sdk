...
namespace Org.OpenAPITools.Model
{
    ...
    /// WalletAction.
    /// </summary>
    public partial class WalletAction5 : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="WalletAction5" /> class.
        /// </summary>
        ...
        [JsonConstructor]
        public WalletAction5(Option<string?> id = default, Option<string?> revision = default, Option<DateTime?> createdDate = default, Option<DateTime?> updatedDate = default, Option<DateTime?> startDate = default, Option<DateTime?> expirationDate = default, Option<DateTime?> disableDate = default, Option<string?> amount = default, Option<string?> note = default, Option<TypeEnum?> type = default, Option<WalletActionExecutionDetails1?> walletActionStarted = default, Option<WalletActionExecutionDetails2?> walletActionEnded = default, Option<StatusEnum?> status = default, Option<ActionInitiator2?> source = default, Option<Notifications1?> notifications = default, Option<bool?> liability = default, Option<StoreCreditContext2?> storeCreditContext = default, Option<ExternalEvent2?> externalEvent = default, Option<string?> walletId = default, Option<string?> idempotencyKey = default)
        {
            IdOption = id;
    ...
    /// <summary>
    /// A Json converter for type <see cref="WalletAction5" />
    /// </summary>
    public class WalletAction5JsonConverter : JsonConverter<WalletAction5>
    {
        /// <summary>
        ...
        /// <summary>
        /// Deserializes json to <see cref="WalletAction5" />
        /// </summary>
        ...
        public override WalletAction5 Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<WalletAction5.TypeEnum?> type = default;
            ...
            Option<WalletAction5.StatusEnum?> status = default;
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        ...
                        case "type":
                            ...
                            if (typeRawValue != null)
                                type = new Option<WalletAction5.TypeEnum?>(WalletAction5.TypeEnumFromStringOrDefault(typeRawValue));
                            break;
                        ...
                        case "status":
                            ...
                            if (statusRawValue != null)
                                status = new Option<WalletAction5.StatusEnum?>(WalletAction5.StatusEnumFromStringOrDefault(statusRawValue));
                            break;
                        case "source":
            ...
            if (id.IsSet && id.Value == null)
                throw new ArgumentNullException(nameof(id), "Property is not nullable for class WalletAction5.");

            if (revision.IsSet && revision.Value == null)
                throw new ArgumentNullException(nameof(revision), "Property is not nullable for class WalletAction5.");

            if (createdDate.IsSet && createdDate.Value == null)
                throw new ArgumentNullException(nameof(createdDate), "Property is not nullable for class WalletAction5.");

            if (updatedDate.IsSet && updatedDate.Value == null)
                throw new ArgumentNullException(nameof(updatedDate), "Property is not nullable for class WalletAction5.");

            if (startDate.IsSet && startDate.Value == null)
                throw new ArgumentNullException(nameof(startDate), "Property is not nullable for class WalletAction5.");

            if (expirationDate.IsSet && expirationDate.Value == null)
                throw new ArgumentNullException(nameof(expirationDate), "Property is not nullable for class WalletAction5.");

            if (disableDate.IsSet && disableDate.Value == null)
                throw new ArgumentNullException(nameof(disableDate), "Property is not nullable for class WalletAction5.");

            if (amount.IsSet && amount.Value == null)
                throw new ArgumentNullException(nameof(amount), "Property is not nullable for class WalletAction5.");

            if (note.IsSet && note.Value == null)
                throw new ArgumentNullException(nameof(note), "Property is not nullable for class WalletAction5.");

            if (type.IsSet && type.Value == null)
                throw new ArgumentNullException(nameof(type), "Property is not nullable for class WalletAction5.");

            if (walletActionStarted.IsSet && walletActionStarted.Value == null)
                throw new ArgumentNullException(nameof(walletActionStarted), "Property is not nullable for class WalletAction5.");

            if (walletActionEnded.IsSet && walletActionEnded.Value == null)
                throw new ArgumentNullException(nameof(walletActionEnded), "Property is not nullable for class WalletAction5.");

            if (status.IsSet && status.Value == null)
                throw new ArgumentNullException(nameof(status), "Property is not nullable for class WalletAction5.");

            if (source.IsSet && source.Value == null)
                throw new ArgumentNullException(nameof(source), "Property is not nullable for class WalletAction5.");

            if (notifications.IsSet && notifications.Value == null)
                throw new ArgumentNullException(nameof(notifications), "Property is not nullable for class WalletAction5.");

            if (liability.IsSet && liability.Value == null)
                throw new ArgumentNullException(nameof(liability), "Property is not nullable for class WalletAction5.");

            if (storeCreditContext.IsSet && storeCreditContext.Value == null)
                throw new ArgumentNullException(nameof(storeCreditContext), "Property is not nullable for class WalletAction5.");

            if (externalEvent.IsSet && externalEvent.Value == null)
                throw new ArgumentNullException(nameof(externalEvent), "Property is not nullable for class WalletAction5.");

            if (walletId.IsSet && walletId.Value == null)
                throw new ArgumentNullException(nameof(walletId), "Property is not nullable for class WalletAction5.");

            if (idempotencyKey.IsSet && idempotencyKey.Value == null)
                throw new ArgumentNullException(nameof(idempotencyKey), "Property is not nullable for class WalletAction5.");

            return new WalletAction5(id, revision, createdDate, updatedDate, startDate, expirationDate, disableDate, amount, note, type, walletActionStarted, walletActionEnded, status, source, notifications, liability, storeCreditContext, externalEvent, walletId, idempotencyKey);
        }

        /// <summary>
        /// Serializes a <see cref="WalletAction5" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="walletAction5"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, WalletAction5 walletAction5, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, walletAction5, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="WalletAction5" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="walletAction5"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, WalletAction5 walletAction5, JsonSerializerOptions jsonSerializerOptions)
        {
            if (walletAction5.IdOption.IsSet && walletAction5.Id == null)
                throw new ArgumentNullException(nameof(walletAction5.Id), "Property is required for class WalletAction5.");

            if (walletAction5.RevisionOption.IsSet && walletAction5.Revision == null)
                throw new ArgumentNullException(nameof(walletAction5.Revision), "Property is required for class WalletAction5.");

            if (walletAction5.AmountOption.IsSet && walletAction5.Amount == null)
                throw new ArgumentNullException(nameof(walletAction5.Amount), "Property is required for class WalletAction5.");

            if (walletAction5.NoteOption.IsSet && walletAction5.Note == null)
                throw new ArgumentNullException(nameof(walletAction5.Note), "Property is required for class WalletAction5.");

            if (walletAction5.WalletActionStartedOption.IsSet && walletAction5.WalletActionStarted == null)
                throw new ArgumentNullException(nameof(walletAction5.WalletActionStarted), "Property is required for class WalletAction5.");

            if (walletAction5.WalletActionEndedOption.IsSet && walletAction5.WalletActionEnded == null)
                throw new ArgumentNullException(nameof(walletAction5.WalletActionEnded), "Property is required for class WalletAction5.");

            if (walletAction5.SourceOption.IsSet && walletAction5.Source == null)
                throw new ArgumentNullException(nameof(walletAction5.Source), "Property is required for class WalletAction5.");

            if (walletAction5.NotificationsOption.IsSet && walletAction5.Notifications == null)
                throw new ArgumentNullException(nameof(walletAction5.Notifications), "Property is required for class WalletAction5.");

            if (walletAction5.StoreCreditContextOption.IsSet && walletAction5.StoreCreditContext == null)
                throw new ArgumentNullException(nameof(walletAction5.StoreCreditContext), "Property is required for class WalletAction5.");

            if (walletAction5.ExternalEventOption.IsSet && walletAction5.ExternalEvent == null)
                throw new ArgumentNullException(nameof(walletAction5.ExternalEvent), "Property is required for class WalletAction5.");

            if (walletAction5.WalletIdOption.IsSet && walletAction5.WalletId == null)
                throw new ArgumentNullException(nameof(walletAction5.WalletId), "Property is required for class WalletAction5.");

            if (walletAction5.IdempotencyKeyOption.IsSet && walletAction5.IdempotencyKey == null)
                throw new ArgumentNullException(nameof(walletAction5.IdempotencyKey), "Property is required for class WalletAction5.");

            if (walletAction5.IdOption.IsSet)
                writer.WriteString("id", walletAction5.Id);

            if (walletAction5.RevisionOption.IsSet)
                writer.WriteString("revision", walletAction5.Revision);

            if (walletAction5.CreatedDateOption.IsSet)
                writer.WriteString("createdDate", walletAction5.CreatedDateOption.Value!.Value.ToString(CreatedDateFormat));

            if (walletAction5.UpdatedDateOption.IsSet)
                writer.WriteString("updatedDate", walletAction5.UpdatedDateOption.Value!.Value.ToString(UpdatedDateFormat));

            if (walletAction5.StartDateOption.IsSet)
                writer.WriteString("startDate", walletAction5.StartDateOption.Value!.Value.ToString(StartDateFormat));

            if (walletAction5.ExpirationDateOption.IsSet)
                writer.WriteString("expirationDate", walletAction5.ExpirationDateOption.Value!.Value.ToString(ExpirationDateFormat));

            if (walletAction5.DisableDateOption.IsSet)
                writer.WriteString("disableDate", walletAction5.DisableDateOption.Value!.Value.ToString(DisableDateFormat));

            if (walletAction5.AmountOption.IsSet)
                writer.WriteString("amount", walletAction5.Amount);

            if (walletAction5.NoteOption.IsSet)
                writer.WriteString("note", walletAction5.Note);

            var typeRawValue = WalletAction5.TypeEnumToJsonValue(walletAction5.TypeOption.Value!.Value);
            writer.WriteString("type", typeRawValue);
            if (walletAction5.WalletActionStartedOption.IsSet)
            {
                writer.WritePropertyName("walletActionStarted");
                JsonSerializer.Serialize(writer, walletAction5.WalletActionStarted, jsonSerializerOptions);
            }
            if (walletAction5.WalletActionEndedOption.IsSet)
            {
                writer.WritePropertyName("walletActionEnded");
                JsonSerializer.Serialize(writer, walletAction5.WalletActionEnded, jsonSerializerOptions);
            }
            var statusRawValue = WalletAction5.StatusEnumToJsonValue(walletAction5.StatusOption.Value!.Value);
            writer.WriteString("status", statusRawValue);
            if (walletAction5.SourceOption.IsSet)
            {
                writer.WritePropertyName("source");
                JsonSerializer.Serialize(writer, walletAction5.Source, jsonSerializerOptions);
            }
            if (walletAction5.NotificationsOption.IsSet)
            {
                writer.WritePropertyName("notifications");
                JsonSerializer.Serialize(writer, walletAction5.Notifications, jsonSerializerOptions);
            }
            if (walletAction5.LiabilityOption.IsSet)
                writer.WriteBoolean("liability", walletAction5.LiabilityOption.Value!.Value);

            if (walletAction5.StoreCreditContextOption.IsSet)
            {
                writer.WritePropertyName("storeCreditContext");
                JsonSerializer.Serialize(writer, walletAction5.StoreCreditContext, jsonSerializerOptions);
            }
            if (walletAction5.ExternalEventOption.IsSet)
            {
                writer.WritePropertyName("externalEvent");
                JsonSerializer.Serialize(writer, walletAction5.ExternalEvent, jsonSerializerOptions);
            }
            if (walletAction5.WalletIdOption.IsSet)
                writer.WriteString("walletId", walletAction5.WalletId);

            if (walletAction5.IdempotencyKeyOption.IsSet)
                writer.WriteString("idempotencyKey", walletAction5.IdempotencyKey);
        }
    }
}

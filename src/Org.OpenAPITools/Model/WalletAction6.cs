...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    public partial class WalletAction6 : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="WalletAction6" /> class.
        /// </summary>
        ...
        [JsonConstructor]
        public WalletAction6(string amount, StoreCreditContext2 storeCreditContext, string walletId, Option<string?> id = default, Option<string?> revision = default, Option<DateTime?> createdDate = default, Option<DateTime?> updatedDate = default, Option<DateTime?> startDate = default, Option<DateTime?> expirationDate = default, Option<DateTime?> disableDate = default, Option<string?> note = default, Option<TypeEnum?> type = default, Option<WalletActionExecutionDetails1?> walletActionStarted = default, Option<WalletActionExecutionDetails2?> walletActionEnded = default, Option<StatusEnum?> status = default, Option<ActionInitiator2?> source = default, Option<Notifications1?> notifications = default, Option<bool?> liability = default, Option<ExternalEvent2?> externalEvent = default, Option<string?> idempotencyKey = default)
        {
            Amount = amount;
    ...
    /// <summary>
    /// A Json converter for type <see cref="WalletAction6" />
    /// </summary>
    public class WalletAction6JsonConverter : JsonConverter<WalletAction6>
    {
        /// <summary>
        ...
        /// <summary>
        /// Deserializes json to <see cref="WalletAction6" />
        /// </summary>
        ...
        public override WalletAction6 Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<WalletAction6.TypeEnum?> type = default;
            ...
            Option<WalletAction6.StatusEnum?> status = default;
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        ...
                        case "type":
                            ...
                            if (typeRawValue != null)
                                type = new Option<WalletAction6.TypeEnum?>(WalletAction6.TypeEnumFromStringOrDefault(typeRawValue));
                            break;
                        ...
                        case "status":
                            ...
                            if (statusRawValue != null)
                                status = new Option<WalletAction6.StatusEnum?>(WalletAction6.StatusEnumFromStringOrDefault(statusRawValue));
                            break;
                        case "source":
            ...
            if (!amount.IsSet)
                throw new ArgumentException("Property is required for class WalletAction6.", nameof(amount));

            if (!storeCreditContext.IsSet)
                throw new ArgumentException("Property is required for class WalletAction6.", nameof(storeCreditContext));

            if (!walletId.IsSet)
                throw new ArgumentException("Property is required for class WalletAction6.", nameof(walletId));

            if (amount.IsSet && amount.Value == null)
                throw new ArgumentNullException(nameof(amount), "Property is not nullable for class WalletAction6.");

            if (storeCreditContext.IsSet && storeCreditContext.Value == null)
                throw new ArgumentNullException(nameof(storeCreditContext), "Property is not nullable for class WalletAction6.");

            if (walletId.IsSet && walletId.Value == null)
                throw new ArgumentNullException(nameof(walletId), "Property is not nullable for class WalletAction6.");

            if (id.IsSet && id.Value == null)
                throw new ArgumentNullException(nameof(id), "Property is not nullable for class WalletAction6.");

            if (revision.IsSet && revision.Value == null)
                throw new ArgumentNullException(nameof(revision), "Property is not nullable for class WalletAction6.");

            if (createdDate.IsSet && createdDate.Value == null)
                throw new ArgumentNullException(nameof(createdDate), "Property is not nullable for class WalletAction6.");

            if (updatedDate.IsSet && updatedDate.Value == null)
                throw new ArgumentNullException(nameof(updatedDate), "Property is not nullable for class WalletAction6.");

            if (startDate.IsSet && startDate.Value == null)
                throw new ArgumentNullException(nameof(startDate), "Property is not nullable for class WalletAction6.");

            if (expirationDate.IsSet && expirationDate.Value == null)
                throw new ArgumentNullException(nameof(expirationDate), "Property is not nullable for class WalletAction6.");

            if (disableDate.IsSet && disableDate.Value == null)
                throw new ArgumentNullException(nameof(disableDate), "Property is not nullable for class WalletAction6.");

            if (note.IsSet && note.Value == null)
                throw new ArgumentNullException(nameof(note), "Property is not nullable for class WalletAction6.");

            if (type.IsSet && type.Value == null)
                throw new ArgumentNullException(nameof(type), "Property is not nullable for class WalletAction6.");

            if (walletActionStarted.IsSet && walletActionStarted.Value == null)
                throw new ArgumentNullException(nameof(walletActionStarted), "Property is not nullable for class WalletAction6.");

            if (walletActionEnded.IsSet && walletActionEnded.Value == null)
                throw new ArgumentNullException(nameof(walletActionEnded), "Property is not nullable for class WalletAction6.");

            if (status.IsSet && status.Value == null)
                throw new ArgumentNullException(nameof(status), "Property is not nullable for class WalletAction6.");

            if (source.IsSet && source.Value == null)
                throw new ArgumentNullException(nameof(source), "Property is not nullable for class WalletAction6.");

            if (notifications.IsSet && notifications.Value == null)
                throw new ArgumentNullException(nameof(notifications), "Property is not nullable for class WalletAction6.");

            if (liability.IsSet && liability.Value == null)
                throw new ArgumentNullException(nameof(liability), "Property is not nullable for class WalletAction6.");

            if (externalEvent.IsSet && externalEvent.Value == null)
                throw new ArgumentNullException(nameof(externalEvent), "Property is not nullable for class WalletAction6.");

            if (idempotencyKey.IsSet && idempotencyKey.Value == null)
                throw new ArgumentNullException(nameof(idempotencyKey), "Property is not nullable for class WalletAction6.");

            return new WalletAction6(amount.Value!, storeCreditContext.Value!, walletId.Value!, id, revision, createdDate, updatedDate, startDate, expirationDate, disableDate, note, type, walletActionStarted, walletActionEnded, status, source, notifications, liability, externalEvent, idempotencyKey);
        }

        /// <summary>
        /// Serializes a <see cref="WalletAction6" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="walletAction6"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, WalletAction6 walletAction6, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, walletAction6, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="WalletAction6" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="walletAction6"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, WalletAction6 walletAction6, JsonSerializerOptions jsonSerializerOptions)
        {
            if (walletAction6.Amount == null)
                throw new ArgumentNullException(nameof(walletAction6.Amount), "Property is required for class WalletAction6.");

            if (walletAction6.StoreCreditContext == null)
                throw new ArgumentNullException(nameof(walletAction6.StoreCreditContext), "Property is required for class WalletAction6.");

            if (walletAction6.WalletId == null)
                throw new ArgumentNullException(nameof(walletAction6.WalletId), "Property is required for class WalletAction6.");

            if (walletAction6.IdOption.IsSet && walletAction6.Id == null)
                throw new ArgumentNullException(nameof(walletAction6.Id), "Property is required for class WalletAction6.");

            if (walletAction6.RevisionOption.IsSet && walletAction6.Revision == null)
                throw new ArgumentNullException(nameof(walletAction6.Revision), "Property is required for class WalletAction6.");

            if (walletAction6.NoteOption.IsSet && walletAction6.Note == null)
                throw new ArgumentNullException(nameof(walletAction6.Note), "Property is required for class WalletAction6.");

            if (walletAction6.WalletActionStartedOption.IsSet && walletAction6.WalletActionStarted == null)
                throw new ArgumentNullException(nameof(walletAction6.WalletActionStarted), "Property is required for class WalletAction6.");

            if (walletAction6.WalletActionEndedOption.IsSet && walletAction6.WalletActionEnded == null)
                throw new ArgumentNullException(nameof(walletAction6.WalletActionEnded), "Property is required for class WalletAction6.");

            if (walletAction6.SourceOption.IsSet && walletAction6.Source == null)
                throw new ArgumentNullException(nameof(walletAction6.Source), "Property is required for class WalletAction6.");

            if (walletAction6.NotificationsOption.IsSet && walletAction6.Notifications == null)
                throw new ArgumentNullException(nameof(walletAction6.Notifications), "Property is required for class WalletAction6.");

            if (walletAction6.ExternalEventOption.IsSet && walletAction6.ExternalEvent == null)
                throw new ArgumentNullException(nameof(walletAction6.ExternalEvent), "Property is required for class WalletAction6.");

            if (walletAction6.IdempotencyKeyOption.IsSet && walletAction6.IdempotencyKey == null)
                throw new ArgumentNullException(nameof(walletAction6.IdempotencyKey), "Property is required for class WalletAction6.");

            writer.WriteString("amount", walletAction6.Amount);

            writer.WritePropertyName("storeCreditContext");
            JsonSerializer.Serialize(writer, walletAction6.StoreCreditContext, jsonSerializerOptions);
            writer.WriteString("walletId", walletAction6.WalletId);

            if (walletAction6.IdOption.IsSet)
                writer.WriteString("id", walletAction6.Id);

            if (walletAction6.RevisionOption.IsSet)
                writer.WriteString("revision", walletAction6.Revision);

            if (walletAction6.CreatedDateOption.IsSet)
                writer.WriteString("createdDate", walletAction6.CreatedDateOption.Value!.Value.ToString(CreatedDateFormat));

            if (walletAction6.UpdatedDateOption.IsSet)
                writer.WriteString("updatedDate", walletAction6.UpdatedDateOption.Value!.Value.ToString(UpdatedDateFormat));

            if (walletAction6.StartDateOption.IsSet)
                writer.WriteString("startDate", walletAction6.StartDateOption.Value!.Value.ToString(StartDateFormat));

            if (walletAction6.ExpirationDateOption.IsSet)
                writer.WriteString("expirationDate", walletAction6.ExpirationDateOption.Value!.Value.ToString(ExpirationDateFormat));

            if (walletAction6.DisableDateOption.IsSet)
                writer.WriteString("disableDate", walletAction6.DisableDateOption.Value!.Value.ToString(DisableDateFormat));

            if (walletAction6.NoteOption.IsSet)
                writer.WriteString("note", walletAction6.Note);

            var typeRawValue = WalletAction6.TypeEnumToJsonValue(walletAction6.TypeOption.Value!.Value);
            writer.WriteString("type", typeRawValue);
            if (walletAction6.WalletActionStartedOption.IsSet)
            {
                writer.WritePropertyName("walletActionStarted");
                JsonSerializer.Serialize(writer, walletAction6.WalletActionStarted, jsonSerializerOptions);
            }
            if (walletAction6.WalletActionEndedOption.IsSet)
            {
                writer.WritePropertyName("walletActionEnded");
                JsonSerializer.Serialize(writer, walletAction6.WalletActionEnded, jsonSerializerOptions);
            }
            var statusRawValue = WalletAction6.StatusEnumToJsonValue(walletAction6.StatusOption.Value!.Value);
            writer.WriteString("status", statusRawValue);
            if (walletAction6.SourceOption.IsSet)
            {
                writer.WritePropertyName("source");
                JsonSerializer.Serialize(writer, walletAction6.Source, jsonSerializerOptions);
            }
            if (walletAction6.NotificationsOption.IsSet)
            {
                writer.WritePropertyName("notifications");
                JsonSerializer.Serialize(writer, walletAction6.Notifications, jsonSerializerOptions);
            }
            if (walletAction6.LiabilityOption.IsSet)
                writer.WriteBoolean("liability", walletAction6.LiabilityOption.Value!.Value);

            if (walletAction6.ExternalEventOption.IsSet)
            {
                writer.WritePropertyName("externalEvent");
                JsonSerializer.Serialize(writer, walletAction6.ExternalEvent, jsonSerializerOptions);
            }
            if (walletAction6.IdempotencyKeyOption.IsSet)
                writer.WriteString("idempotencyKey", walletAction6.IdempotencyKey);
        }
    }
}

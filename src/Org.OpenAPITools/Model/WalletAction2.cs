...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    public partial class WalletAction2 : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="WalletAction2" /> class.
        /// </summary>
        ...
        [JsonConstructor]
        public WalletAction2(Option<string?> id = default, Option<string?> revision = default, Option<DateTime?> createdDate = default, Option<DateTime?> updatedDate = default, Option<DateTime?> startDate = default, Option<DateTime?> expirationDate = default, Option<DateTime?> disableDate = default, Option<string?> amount = default, Option<string?> note = default, Option<TypeEnum?> type = default, Option<WalletActionExecutionDetails1?> walletActionStarted = default, Option<WalletActionExecutionDetails2?> walletActionEnded = default, Option<StatusEnum?> status = default, Option<ActionInitiator2?> source = default, Option<Notifications1?> notifications = default, Option<bool?> liability = default, Option<StoreCreditContext2?> storeCreditContext = default, Option<ExternalEvent2?> externalEvent = default, Option<string?> walletId = default, Option<string?> idempotencyKey = default)
        {
            IdOption = id;
    ...
    /// <summary>
    /// A Json converter for type <see cref="WalletAction2" />
    /// </summary>
    public class WalletAction2JsonConverter : JsonConverter<WalletAction2>
    {
        /// <summary>
        ...
        /// <summary>
        /// Deserializes json to <see cref="WalletAction2" />
        /// </summary>
        ...
        public override WalletAction2 Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<WalletAction2.TypeEnum?> type = default;
            ...
            Option<WalletAction2.StatusEnum?> status = default;
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        ...
                        case "type":
                            ...
                            if (typeRawValue != null)
                                type = new Option<WalletAction2.TypeEnum?>(WalletAction2.TypeEnumFromStringOrDefault(typeRawValue));
                            break;
                        ...
                        case "status":
                            ...
                            if (statusRawValue != null)
                                status = new Option<WalletAction2.StatusEnum?>(WalletAction2.StatusEnumFromStringOrDefault(statusRawValue));
                            break;
                        case "source":
            ...
            if (id.IsSet && id.Value == null)
                throw new ArgumentNullException(nameof(id), "Property is not nullable for class WalletAction2.");

            if (revision.IsSet && revision.Value == null)
                throw new ArgumentNullException(nameof(revision), "Property is not nullable for class WalletAction2.");

            if (createdDate.IsSet && createdDate.Value == null)
                throw new ArgumentNullException(nameof(createdDate), "Property is not nullable for class WalletAction2.");

            if (updatedDate.IsSet && updatedDate.Value == null)
                throw new ArgumentNullException(nameof(updatedDate), "Property is not nullable for class WalletAction2.");

            if (startDate.IsSet && startDate.Value == null)
                throw new ArgumentNullException(nameof(startDate), "Property is not nullable for class WalletAction2.");

            if (expirationDate.IsSet && expirationDate.Value == null)
                throw new ArgumentNullException(nameof(expirationDate), "Property is not nullable for class WalletAction2.");

            if (disableDate.IsSet && disableDate.Value == null)
                throw new ArgumentNullException(nameof(disableDate), "Property is not nullable for class WalletAction2.");

            if (amount.IsSet && amount.Value == null)
                throw new ArgumentNullException(nameof(amount), "Property is not nullable for class WalletAction2.");

            if (note.IsSet && note.Value == null)
                throw new ArgumentNullException(nameof(note), "Property is not nullable for class WalletAction2.");

            if (type.IsSet && type.Value == null)
                throw new ArgumentNullException(nameof(type), "Property is not nullable for class WalletAction2.");

            if (walletActionStarted.IsSet && walletActionStarted.Value == null)
                throw new ArgumentNullException(nameof(walletActionStarted), "Property is not nullable for class WalletAction2.");

            if (walletActionEnded.IsSet && walletActionEnded.Value == null)
                throw new ArgumentNullException(nameof(walletActionEnded), "Property is not nullable for class WalletAction2.");

            if (status.IsSet && status.Value == null)
                throw new ArgumentNullException(nameof(status), "Property is not nullable for class WalletAction2.");

            if (source.IsSet && source.Value == null)
                throw new ArgumentNullException(nameof(source), "Property is not nullable for class WalletAction2.");

            if (notifications.IsSet && notifications.Value == null)
                throw new ArgumentNullException(nameof(notifications), "Property is not nullable for class WalletAction2.");

            if (liability.IsSet && liability.Value == null)
                throw new ArgumentNullException(nameof(liability), "Property is not nullable for class WalletAction2.");

            if (storeCreditContext.IsSet && storeCreditContext.Value == null)
                throw new ArgumentNullException(nameof(storeCreditContext), "Property is not nullable for class WalletAction2.");

            if (externalEvent.IsSet && externalEvent.Value == null)
                throw new ArgumentNullException(nameof(externalEvent), "Property is not nullable for class WalletAction2.");

            if (walletId.IsSet && walletId.Value == null)
                throw new ArgumentNullException(nameof(walletId), "Property is not nullable for class WalletAction2.");

            if (idempotencyKey.IsSet && idempotencyKey.Value == null)
                throw new ArgumentNullException(nameof(idempotencyKey), "Property is not nullable for class WalletAction2.");

            return new WalletAction2(id, revision, createdDate, updatedDate, startDate, expirationDate, disableDate, amount, note, type, walletActionStarted, walletActionEnded, status, source, notifications, liability, storeCreditContext, externalEvent, walletId, idempotencyKey);
        }

        /// <summary>
        /// Serializes a <see cref="WalletAction2" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="walletAction2"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, WalletAction2 walletAction2, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, walletAction2, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="WalletAction2" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="walletAction2"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, WalletAction2 walletAction2, JsonSerializerOptions jsonSerializerOptions)
        {
            if (walletAction2.IdOption.IsSet && walletAction2.Id == null)
                throw new ArgumentNullException(nameof(walletAction2.Id), "Property is required for class WalletAction2.");

            if (walletAction2.RevisionOption.IsSet && walletAction2.Revision == null)
                throw new ArgumentNullException(nameof(walletAction2.Revision), "Property is required for class WalletAction2.");

            if (walletAction2.AmountOption.IsSet && walletAction2.Amount == null)
                throw new ArgumentNullException(nameof(walletAction2.Amount), "Property is required for class WalletAction2.");

            if (walletAction2.NoteOption.IsSet && walletAction2.Note == null)
                throw new ArgumentNullException(nameof(walletAction2.Note), "Property is required for class WalletAction2.");

            if (walletAction2.WalletActionStartedOption.IsSet && walletAction2.WalletActionStarted == null)
                throw new ArgumentNullException(nameof(walletAction2.WalletActionStarted), "Property is required for class WalletAction2.");

            if (walletAction2.WalletActionEndedOption.IsSet && walletAction2.WalletActionEnded == null)
                throw new ArgumentNullException(nameof(walletAction2.WalletActionEnded), "Property is required for class WalletAction2.");

            if (walletAction2.SourceOption.IsSet && walletAction2.Source == null)
                throw new ArgumentNullException(nameof(walletAction2.Source), "Property is required for class WalletAction2.");

            if (walletAction2.NotificationsOption.IsSet && walletAction2.Notifications == null)
                throw new ArgumentNullException(nameof(walletAction2.Notifications), "Property is required for class WalletAction2.");

            if (walletAction2.StoreCreditContextOption.IsSet && walletAction2.StoreCreditContext == null)
                throw new ArgumentNullException(nameof(walletAction2.StoreCreditContext), "Property is required for class WalletAction2.");

            if (walletAction2.ExternalEventOption.IsSet && walletAction2.ExternalEvent == null)
                throw new ArgumentNullException(nameof(walletAction2.ExternalEvent), "Property is required for class WalletAction2.");

            if (walletAction2.WalletIdOption.IsSet && walletAction2.WalletId == null)
                throw new ArgumentNullException(nameof(walletAction2.WalletId), "Property is required for class WalletAction2.");

            if (walletAction2.IdempotencyKeyOption.IsSet && walletAction2.IdempotencyKey == null)
                throw new ArgumentNullException(nameof(walletAction2.IdempotencyKey), "Property is required for class WalletAction2.");

            if (walletAction2.IdOption.IsSet)
                writer.WriteString("id", walletAction2.Id);

            if (walletAction2.RevisionOption.IsSet)
                writer.WriteString("revision", walletAction2.Revision);

            if (walletAction2.CreatedDateOption.IsSet)
                writer.WriteString("createdDate", walletAction2.CreatedDateOption.Value!.Value.ToString(CreatedDateFormat));

            if (walletAction2.UpdatedDateOption.IsSet)
                writer.WriteString("updatedDate", walletAction2.UpdatedDateOption.Value!.Value.ToString(UpdatedDateFormat));

            if (walletAction2.StartDateOption.IsSet)
                writer.WriteString("startDate", walletAction2.StartDateOption.Value!.Value.ToString(StartDateFormat));

            if (walletAction2.ExpirationDateOption.IsSet)
                writer.WriteString("expirationDate", walletAction2.ExpirationDateOption.Value!.Value.ToString(ExpirationDateFormat));

            if (walletAction2.DisableDateOption.IsSet)
                writer.WriteString("disableDate", walletAction2.DisableDateOption.Value!.Value.ToString(DisableDateFormat));

            if (walletAction2.AmountOption.IsSet)
                writer.WriteString("amount", walletAction2.Amount);

            if (walletAction2.NoteOption.IsSet)
                writer.WriteString("note", walletAction2.Note);

            var typeRawValue = WalletAction2.TypeEnumToJsonValue(walletAction2.TypeOption.Value!.Value);
            writer.WriteString("type", typeRawValue);
            if (walletAction2.WalletActionStartedOption.IsSet)
            {
                writer.WritePropertyName("walletActionStarted");
                JsonSerializer.Serialize(writer, walletAction2.WalletActionStarted, jsonSerializerOptions);
            }
            if (walletAction2.WalletActionEndedOption.IsSet)
            {
                writer.WritePropertyName("walletActionEnded");
                JsonSerializer.Serialize(writer, walletAction2.WalletActionEnded, jsonSerializerOptions);
            }
            var statusRawValue = WalletAction2.StatusEnumToJsonValue(walletAction2.StatusOption.Value!.Value);
            writer.WriteString("status", statusRawValue);
            if (walletAction2.SourceOption.IsSet)
            {
                writer.WritePropertyName("source");
                JsonSerializer.Serialize(writer, walletAction2.Source, jsonSerializerOptions);
            }
            if (walletAction2.NotificationsOption.IsSet)
            {
                writer.WritePropertyName("notifications");
                JsonSerializer.Serialize(writer, walletAction2.Notifications, jsonSerializerOptions);
            }
            if (walletAction2.LiabilityOption.IsSet)
                writer.WriteBoolean("liability", walletAction2.LiabilityOption.Value!.Value);

            if (walletAction2.StoreCreditContextOption.IsSet)
            {
                writer.WritePropertyName("storeCreditContext");
                JsonSerializer.Serialize(writer, walletAction2.StoreCreditContext, jsonSerializerOptions);
            }
            if (walletAction2.ExternalEventOption.IsSet)
            {
                writer.WritePropertyName("externalEvent");
                JsonSerializer.Serialize(writer, walletAction2.ExternalEvent, jsonSerializerOptions);
            }
            if (walletAction2.WalletIdOption.IsSet)
                writer.WriteString("walletId", walletAction2.WalletId);

            if (walletAction2.IdempotencyKeyOption.IsSet)
                writer.WriteString("idempotencyKey", walletAction2.IdempotencyKey);
        }
    }
}

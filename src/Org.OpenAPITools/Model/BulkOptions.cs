...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class BulkOptions : IValidatableObject
    {
        ...
        [JsonConstructor]
        public BulkOptions(Option<string?> bulkId = default, Option<bool?> liability = default, Option<string?> note = default)
        {
            BulkIdOption = bulkId;
    ...
    public class BulkOptionsJsonConverter : JsonConverter<BulkOptions>
    {
        ...
        public override BulkOptions Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (bulkId.IsSet && bulkId.Value == null)
                throw new ArgumentNullException(nameof(bulkId), "Property is not nullable for class BulkOptions.");

            if (liability.IsSet && liability.Value == null)
                throw new ArgumentNullException(nameof(liability), "Property is not nullable for class BulkOptions.");

            if (note.IsSet && note.Value == null)
                throw new ArgumentNullException(nameof(note), "Property is not nullable for class BulkOptions.");

            return new BulkOptions(bulkId, liability, note);
        }
        ...
        {
            if (bulkOptions.BulkIdOption.IsSet && bulkOptions.BulkId == null)
                throw new ArgumentNullException(nameof(bulkOptions.BulkId), "Property is required for class BulkOptions.");

            if (bulkOptions.NoteOption.IsSet && bulkOptions.Note == null)
                throw new ArgumentNullException(nameof(bulkOptions.Note), "Property is required for class BulkOptions.");

            if (bulkOptions.BulkIdOption.IsSet)
                writer.WriteString("bulkId", bulkOptions.BulkId);

            if (bulkOptions.LiabilityOption.IsSet)
                writer.WriteBoolean("liability", bulkOptions.LiabilityOption.Value!.Value);

            if (bulkOptions.NoteOption.IsSet)
                writer.WriteString("note", bulkOptions.Note);
        }
    }
}

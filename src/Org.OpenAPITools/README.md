...
inputSpec: /tmp/sdk-build-1762942032446/openapi.json
outputDir: out

# https://openapi-generator.tech/docs/generators/csharp
additionalProperties:
  packageGuid: '{BE7F84CC-3F25-4759-A431-C5D97054F88A}'
...
namespace YourProject
{
    public class Program
    {
        public static async Task Main(string[] args)
        {
            ...
            var api = host.Services.GetRequiredService<IGiftCardApi>();
            ICountGiftCardsApiResponse apiResponse = await api.CountGiftCardsAsync("todo");
            CountGiftCardsResponse1? model = apiResponse.Ok();
        }
...
## Api Information
- appName: Rise.ai API Documentation
- appVersion: 2.0
